            ...
            <table cellspacing="40" cellpadding="0" bgcolor="#ffffff" border="0">
                ...
                <tr>
                    <td>
                        ...
                        <p><a href='http://localhost/NewUI/uber_verification.php?token=[token_value]'>Verify
                                Account</a></p>
    ...
    <tr>
        <td align="center">
            <table cellspacing="40" cellpadding="0" bgcolor="#ffffff" border="0">
                ...
                <tr>
                    <td>
                        <p>To reset your Uber password. Please click the button below:</p>
                        <p><a href='http://localhost/NewUI/uber_change_password.php?token=[token_value]'>Change
                                Password</a></p>
