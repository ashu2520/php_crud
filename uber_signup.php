...
if (isset($_POST["name"]) && isset($_POST["email"]) && isset($_POST["mobile"]) && isset($_POST["password"]) && isset($_POST["confirm_pass"]) && isset($_POST["gender"]) && isset($_POST['User_type']) && isset($_POST['country']) && isset($_POST['state'])) {
    ...
    # Email check
    $sql_em = "SELECT * FROM `employees` WHERE emp_email = '$email'";
    ...
    if (!$nameerr && !$emailerr && !$mobilerr && !$location_error && !$position_error && !$passworderr && !$confirm_pass_err) {
        $sql = "INSERT INTO `employees` (emp_name, emp_mobile, emp_email, emp_gender, emp_country, emp_state, emp_type, emp_password, emp_terms_cond, emp_created_at, emp_updated_at) VALUES ('$name', '$mobile', '$email', '$gender', '$country', '$state', '$position', '$hashed_password', '$terms_cond', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
        ...
        if ($result) {
            ...
            $sql_token = "INSERT INTO `security_token` (`token_user_email`, `token_type`, `token_value`, `token_expiry_time`, `token_created_at`, `token_updated_at`) VALUES ( '$email', 'Uber Account Verificatioin', '$randomHash',  DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 48 HOUR), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
            $result_token = mysqli_query($conn, $sql_token);

            $temp_slug = 'uber_verification_link';
...
<body>
    <div style="margin-top: -20px;" class="login_section">
        <!-- <div class="wrapper relative"> -->
        <!-- <div style="display:none" class="meassage_successful_login">You have Successfull Edit </div> -->
        <div class="heading-top">
            <div class="logo-cebter"><a href="#"><img src="images/uber.png"></a>
            </div>
        </div>
        <div class="box_signup">
            <div class="outer_div">

                <h2>Employee <span style="color: white;">Registration</span></h2>
                <?php
                if ($error) {
                ...
                <form id="main" class="margin_bottom" role="form" onsubmit="validateForm(); return false;"
                    action="uber_signup.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input id="gender_male" class="rad_opt" checked type="radio" name="gender"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password_input" class="form-control" name="password"
                            placeholder="Password" autocomplete="off" oninput="validatePassword()">
                        ...
                        <div class="tool-tip-signup">
                            ...
                            <div class="tool-tip-signup-error">
                                ...
                                <p id="password-uppercase"><i class="fa-solid fa-xmark"></i> A capital (Uppercase)
                                    letter.
                                </p>
                    ...
                    <!-- <div class="form-group">
                        <div class="check_box">
                            <label for="terms" style="display: flex;  margin-top: -5px;" class="container">I agree on the terms and conditions.
                ...
                <div class="login">
                    <p>Already have an account? <a href="uber_login.php"> Login</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="js/uber_signup.js"></script>
</body>
